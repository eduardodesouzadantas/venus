  ...
  return (
    <div className="relative z-0 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-black px-5 py-6 sm:p-6">
      <div className="absolute inset-0 z-0 flex items-center justify-center">
        ...
        <div className="absolute h-[100vw] w-[100vw] max-h-[520px] max-w-[520px] animate-[spin_8s_linear_infinite_reverse] rounded-full border border-[#D4AF37]/20 sm:h-[120vw] sm:w-[120vw] sm:max-h-[600px] sm:max-w-[600px]" />
      </div>
      ...
      <div className="z-10 mb-8 flex h-32 w-32 items-center justify-center rounded-full border border-white/10 bg-white/5 p-6 shadow-[0_0_50px_rgba(212,175,55,0.1)] backdrop-blur-[30px] sm:mb-10 sm:h-40 sm:w-40 sm:p-8">
        <svg className="h-12 w-12 animate-pulse text-[#D4AF37] sm:h-16 sm:w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M5 13l4 4L19 7" />
        </svg>
      </div>

      <div className="z-10 w-full max-w-[300px] text-center">
        <Heading as="h4" className="mb-2 font-serif text-base tracking-widest text-[#D4AF37] transition-opacity duration-300 sm:text-lg">
          VENUS ENGINE CORE
        </Heading>
