    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-white/[0.05] via-transparent to-transparent">
      ...
      <div className="w-full max-w-lg space-y-12">
         <div className="flex flex-col items-center text-center space-y-4">
            <div className="w-16 h-16 rounded-full bg-[#C9A84C] flex items-center justify-center text-black font-serif text-2xl font-bold shadow-[0_0_40px_rgba(212,175,55,0.4)]">V</div>
            <div className="space-y-1">
               <Text className="text-[10px] uppercase font-bold tracking-[0.6em] text-[#C9A84C]">Venus Architecture</Text>
         ...
         <div className="grid grid-cols-1 gap-6">
            ...
            <Link href="/agency" className="group">
               <div className="p-8 rounded-[48px] bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] hover:border-[#C9A84C]/40 transition-all flex items-center justify-between relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                     <ShieldCheck size={120} />
                  </div>
                  <div className="flex items-center gap-6">
                     <div className="w-14 h-14 rounded-3xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-[#C9A84C] group-hover:text-black transition-all">
                        <Lock size={24} />
                     </div>
                  ...
                  <ChevronRight size={20} className="text-white/10 group-hover:text-[#C9A84C] group-hover:translate-x-1 transition-all" />
               </div>
            </Link>
         ...
         {/* Separation Info */}
         <div className="p-10 rounded-[60px] bg-[#C9A84C]/5 border border-[#C9A84C]/20 flex items-start gap-5">
            <ShieldCheck className="w-6 h-6 text-[#C9A84C] flex-shrink-0 mt-1" />
            <div className="space-y-4">
               ...
               <div className="flex items-center gap-8 pt-2">
                  <div className="flex flex-col gap-1">
                     <span className="text-[9px] text-[#C9A84C] font-bold uppercase tracking-widest">Agency Levels</span>
