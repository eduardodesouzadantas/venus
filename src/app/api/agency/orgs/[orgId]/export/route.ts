  ...
  try {
    ...
    if (format === "csv") {
      const csv = rowsToCsv([summary], [
        ...
        { header: "historical_whatsapp_conversations_count", value: (row) => row.historical_whatsapp_conversations_count ?? "" },
        { header: "historical_whatsapp_messages_count", value: (row) => row.historical_whatsapp_messages_count ?? "" },
        { header: "historical_whatsapp_first_activity_at", value: (row) => row.historical_whatsapp_first_activity_at || "" },
        { header: "historical_whatsapp_last_activity_at", value: (row) => row.historical_whatsapp_last_activity_at || "" },
