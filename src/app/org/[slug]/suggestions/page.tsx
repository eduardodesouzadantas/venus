        ...
        <header className="mb-6 flex flex-col gap-5 rounded-[32px] border border-[#1e2820] bg-[#0f1410] p-5 md:flex-row md:items-end md:justify-between">
          <div className="space-y-2">
            ...
            <Heading as="h1" className="text-3xl md:text-4xl uppercase tracking-tighter leading-none">
              Sugestões com ação prática
            </Heading>
            <Text className="max-w-2xl text-sm text-[#6b7d6c]">
              Lista operacional com prioridade, recomendação e data para o lojista concluir o próximo movimento.
            </Text>
          </div>

          <div className="flex flex-wrap gap-3">
            <div className="rounded-full border border-[#1e2820] bg-[#141a15] px-4 py-3 text-[10px] uppercase tracking-[0.3em] text-[#ff4444]">
              {formatNumber(counters.urgente)} urgentes
            </div>
            <div className="rounded-full border border-[#1e2820] bg-[#141a15] px-4 py-3 text-[10px] uppercase tracking-[0.3em] text-[#ffaa00]">
              {formatNumber(counters.oportunidade)} oportunidades
            </div>
            <div className="rounded-full border border-[#1e2820] bg-[#141a15] px-4 py-3 text-[10px] uppercase tracking-[0.3em] text-[#00ff88]">
              {formatNumber(counters.viral)} virais
            </div>
          </div>
        </header>
