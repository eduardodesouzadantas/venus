...
export function buildOnboardingSeedFromSnapshot(
  ...
  return {
    ...
    colorimetry: {
      ...
      favoriteColors: asStringArray(colorProfile.favoriteColors),
      avoidColors: asStringArray(colorProfile.avoidColors),
      confidence: "medium" as OnboardingData["colorimetry"]["confidence"],
      evidence: "",
      basePalette: asStringArray(colorProfile.favoriteColors),
      accentPalette: [],
      avoidOrUseCarefully: asStringArray(colorProfile.avoidColors),
